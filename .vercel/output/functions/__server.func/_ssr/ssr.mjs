...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-LaZRt8b6.mjs");
...
var manifest = {
	"2680f8c3ecdd9057ba466554ea5aaae8231765a236eddb2029a0aa000e59070c": {
		functionName: "getCatalog_createServerFn_handler",
		importer: () => import("./functions-QTn21H8e.mjs")
	},
	"ec207cf9dd6dbc229ee25d1da08b840d4fa81e4e4dd7084712d6251fa01e27a7": {
		functionName: "getItemDetail_createServerFn_handler",
		importer: () => import("./functions-QTn21H8e.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DRqT8nEJ.mjs").then((n) => n.t),
