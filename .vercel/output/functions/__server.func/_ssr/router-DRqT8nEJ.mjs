...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DRqT8nEJ.js
...
var styles_default = "/assets/styles-C5qVd6FO.css";
var APP_NAME = "Flea Scan";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Live Tarkov flea market prices — top 5 cheapest scans for any item, built for raid."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DqWAtI2Q.mjs");
var Route = createFileRoute("/")({
	validateSearch: (search) => ({
		q: typeof search.q === "string" ? search.q : void 0,
		item: typeof search.item === "string" ? search.item : void 0,
		mode: search.mode === "pve" || search.mode === "regular" ? search.mode : void 0
	}),
